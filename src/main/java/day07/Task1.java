...
public class Task1 {
    ...
    private void run() {
        ...
        var hands = lines.stream().map(this::parseHand).sorted().toList();
        var acc = 0;
    ...
    static class Hand implements Comparable<Hand> {
        ...
        static final Comparator<Hand> HAND_COMPARATOR = Comparator.comparing(Hand::getStrength)
          .thenComparing((o1, o2) -> {
        ...
        public int compareTo(Hand other) {
            return HAND_COMPARATOR.compare(this, other);
        }
    }
}
